...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('arrived', 'Arrived'), ('departed', 'Departed')], max_length=10)),
                ...
                ('statut', models.CharField(choices=[('in_progress', 'In Progress'), ('processed', 'Processed'), ('pending', 'Pending')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mails.role')),
            ],
            options={
                'verbose_name': 'user',
